                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.update', $user->id) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="fast_name" type="text" class="form-control @error('fast_name') is-invalid @enderror" name="fast_name" value="{{ old('fast_name', $user->fast_name) }}" required autocomplete="fast_name" autofocus>
